...
public class DefaultMessage {
    ...
    public final static String UNKNOWN_ERROR_CHECK_ACCOUNT_BALANCE = "Unknown error. Please check account balance.";
    public final static String PRIVATE_CHAT_COMMAND_IN_PUBLIC_CHAT = "This command can only be used in private chat.\nSend me a message!";
